      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-12 flex flex-col items-center text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-2">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em]">© 2026 Sunjay&apos;s Book • All Rights Reserved</p>
            <p className="text-[8px] font-black text-indigo-300 uppercase tracking-widest bg-indigo-50/50 px-3 py-1 rounded-full border border-indigo-100/50">v0.1.2-beta • Sagar Edition</p>
          </div>
        </footer>
      </div>
    </main>
